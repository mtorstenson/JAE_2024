...
plot(mortality,one_virulence_800_08(migrant_m == 0.8,:)-1,'-','Linewidth', 2)
yline(one_virulence_800_08(find(migrant_m==0.8),mortality==0.09)-1,'-',{'m=0.8, f=1'})
ylim([0,10])
ylabel('Pathogen Strategy','FontSize',fs1)
xlabel('Mortality rate','FontSize',fs1)
...
%creates figure where migrants and residents differ only in mortality rate
figure(2); clf
hh = gcf;
set(hh,'PaperUnits','centimeters');
set(hh,'Units','centimeters');
...
hold on
plot(mortality,final_res_pop_800_08(migrant_m==0.8,:)','-','Linewidth', 2)
plot(mortality,final_mig_pop_800_08(migrant_m==0.8,:)','-','Linewidth', 2)
xline(bmx,'-',{'miu_R'})
yline(0)
yline(orig_res_pop_800_08,'-','N_R')
ylabel('Population Size','FontSize',fs1)
xlabel('Mortality rate of migrants','FontSize',fs1)
title('','FontSize',tfsize)
...
plot(mortality,delta_v_800_08(migrant_m==0.8,:)','-','Linewidth', 2)
xline(bmx,'-',{'miu_R'})
yline(0)
...
print -dtiff -r600 2Fig1.tiff % save as 600dpi tiff
saveas(1,strcat(['2Fig1.jpg']))
print -dpdf -r600 2Fig1.pdf

print -dtiff -r600 2Fig2.tiff % save as 600dpi tiff
saveas(2,strcat(['2Fig2.jpg']))
print -dpdf -r600 2Fig2.pdf
